...
module.exports = function(Characteristic) {
    // HAP 2.x removed the Characteristic.Perms static; fall back to the raw
    // permission codes ('pr' = read, 'ev' = notify) so this works on both.
    const Perms = Characteristic.Perms || {READ: 'pr', NOTIFY: 'ev'};
