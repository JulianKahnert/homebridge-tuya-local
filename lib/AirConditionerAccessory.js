...
class AirConditionerAccessory extends BaseAccessory {
    ...
    convertRotationSpeedFromTuyaToHomeKit(value) {
        ...
        const mapped = this._rotationStops[parseInt(value)];
        this.log.debug('[AC %s] convertRotationSpeedFromTuyaToHomeKit raw=%s -> hk=%s', this.device.context.name, value, mapped);
        return mapped;
    }
